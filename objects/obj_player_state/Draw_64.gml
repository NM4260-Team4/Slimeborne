...
draw_roundrect_color_ext(495, _height -226, 309, _height - 46, 50, 50, #4A5368, #4A5368, 0);
draw_sprite_ext(spr_frame, -1, 405, _height - 135, 0.3, 0.3, 90, c_white, 1);
if (global.equipped.has_attachment) {
	draw_sprite(global.equipped_attachment.sprite_index, 0, 405, _height - 135);
}
